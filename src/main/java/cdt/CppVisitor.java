			...
			if(declSpecifier instanceof CPPASTElaboratedTypeSpecifier) {
				...
				for (IASTDeclarator declarator : simpleDeclaration.getDeclarators()) {
					if(declarator instanceof CPPASTFunctionDeclarator){
						entity = context.FoundFunctionDeclaration((CPPASTFunctionDeclarator) declarator, declSpecifier);
				...
				if(declSpecifier.isFriend()) {
					...
					for (IASTDeclarator declarator : simpleDeclaration.getDeclarators()) {
						 ...
						 * TODO: 判断是否为extern
						 */
						entity = context.foundVarDefinition(varName, context.getLocation(declarator.getName()), type, false);
