...
public class ClassSymbol extends DataAggregateSymbol {
	...
	public ClassSymbol(String name, int id) {
		super(name, id);
	}
	...
	public ClassSymbol getSuperClassScope() {
		if ( superClassName!=null ) {
			if ( getEnclosingScope()!=null ) {
				Symbol superClass = getEnclosingScope().resolve(superClassName, Configure.Class);
	...
	public MethodSymbol resolveMethod(String name) {
		Symbol s = resolveMember(name, Configure.Function);
