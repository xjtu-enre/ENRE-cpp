...
public class StructMethodTest {
	...
	/**
	  ...
	  */
	@Test
	public void containsFunctionEntityfunc2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("func") && x.getLocation().getStartLine() == 2);
