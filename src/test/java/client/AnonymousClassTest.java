...
public class AnonymousClassTest {
	...
	/**
	  * contains Class entity <Anonymous as="Class">
	  */
	@Test
	public void containsClassEntity_Anonymous_asClass_1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isClass(x) && x.getName().equals("_Anonymous_asClass_") && x.getLocation().getStartLine() == 1);
