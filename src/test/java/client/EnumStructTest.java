...
public class EnumStructTest {
	...
	/**
	  * contains Enum entity Handle
	  */
	@Test
	public void containsEnumEntityHandle1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isEnum(x) && x.getName().equals("Handle") && x.getLocation().getStartLine() == 1);
