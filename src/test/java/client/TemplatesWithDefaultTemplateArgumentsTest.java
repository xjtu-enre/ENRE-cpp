...
public class TemplatesWithDefaultTemplateArgumentsTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "templates-with-default-template-arguments";
	...
	/**
	  * contains Template entity vector
	  */
	@Test
	public void containsTemplateEntityvector1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("vector") && x.getLocation().getStartLine() == 1);
