...
public class MemberObjectTest {
	...
	/**
	  * contains Variable entity member
	  */
	@Test
	public void containsVariableEntitymember3() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("member") && x.getLocation().getStartLine() == 3);
