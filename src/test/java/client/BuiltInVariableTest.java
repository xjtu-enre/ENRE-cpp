...
public class BuiltInVariableTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "built-in-variable";
	...
	/**
	  ...
	  */
	@Test
	public void containsVariableEntityx1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("x") && x.getLocation().getStartLine() == 1);
