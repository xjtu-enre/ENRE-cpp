...
public class StructTest {
	...
	/**
	  * contains Struct entity MyStruct
	  */
	@Test
	public void containsStructEntityMyStruct1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isStruct(x) && x.getName().equals("MyStruct") && x.getLocation().getStartLine() == 1);
