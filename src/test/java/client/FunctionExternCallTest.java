...
public class FunctionExternCallTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "function-extern-call";
	...
	public void containsCallRelationDescribedInIndex0() {
		...
		List<Entity> toEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("func1"));
