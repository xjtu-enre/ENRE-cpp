...
public class FunctionCallTemplateTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "function-call-template";
	...
	public void containsCallRelationDescribedInIndex0() {
		List<Entity> fromEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("func2"));
