...
public class AnonymousStructTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "anonymous-struct";
	...
	/**
	  * contains Struct entity <Anonymous as="Struct">
	  */
	@Test
	public void containsStructEntity_Anonymous_asStruct_1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isStruct(x) && x.getName().equals("_Anonymous_asStruct_") && x.getLocation().getStartLine() == 1);
