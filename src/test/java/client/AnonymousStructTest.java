...
//
//	/**
//	  * contains Struct entity unnamed
//	  */
//	@Test
//	public void containsStructEntityunnamed1() {
//		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isStruct(x) && x.getName().equals("unnamed") && x.getLocation().getStartLine() == 1);
