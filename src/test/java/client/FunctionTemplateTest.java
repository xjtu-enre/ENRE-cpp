...
public class FunctionTemplateTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "function-template";
	...
	/**
	  * contains Template entity func
	  */
	@Test
	public void containsTemplateEntityfunc2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("func") && x.getLocation().getStartLine() == 2);
