...
public class UnionTest {
	...
	/**
	  * contains Union entity month
	  */
	@Test
	public void containsUnionEntitymonth1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isUnion(x) && x.getName().equals("month") && x.getLocation().getStartLine() == 1);
