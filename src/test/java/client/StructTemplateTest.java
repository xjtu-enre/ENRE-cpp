...
public class StructTemplateTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "struct-template";
	...
	/**
	  * contains Template entity S
	  */
	@Test
	public void containsTemplateEntityS2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("S") && x.getLocation().getStartLine() == 2);
