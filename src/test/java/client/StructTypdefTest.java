...
public class StructTypdefTest {
	...
	/**
	  * contains Typedef entity range
	  */
	@Test
	public void containsTypedefEntityrange1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTypedef(x) && x.getName().equals("range") && x.getLocation().getStartLine() == 1);
