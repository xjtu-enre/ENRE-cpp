...
public class AllocateSpaceForPointerTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "allocate-space-for-pointer";
	...
	/**
	  * contains Variable entity p
	  */
	@Test
	public void containsVariableEntityp1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("p") && x.getLocation().getStartLine() == 1);
