...
public class EnumTest {
	...
	/**
	  * contains Enum entity Color
	  */
	@Test
	public void containsEnumEntityColor1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isEnum(x) && x.getName().equals("Color") && x.getLocation().getStartLine() == 1);
