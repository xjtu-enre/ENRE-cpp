...
public class SingleObjectDeletionTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "single-object-deletion";
	...
	public void containsundefinedRelationDescribedInIndex0() {
		...
		List<Entity> toEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("obj"));
