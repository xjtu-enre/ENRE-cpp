...
public class TypedefBuiltInTypeTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "typedef-built-in-type";
	...
	/**
	  * contains Typedef entity int_t
	  */
	@Test
	public void containsTypedefEntityint_t1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTypedef(x) && x.getName().equals("int_t") && x.getLocation().getStartLine() == 1);
