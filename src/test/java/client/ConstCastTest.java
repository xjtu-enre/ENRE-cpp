...
public class ConstCastTest {
	...
	public void execute() throws Exception {
		String groupName = "cast";
		String caseName = "const-cast";
	...
	public void containsundefinedRelationDescribedInIndex0() {
		...
		List<Entity> toEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("val"));
