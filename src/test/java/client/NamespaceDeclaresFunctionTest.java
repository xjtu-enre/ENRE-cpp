...
public class NamespaceDeclaresFunctionTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "namespace-declares-function";
	...
	public void containsundefinedRelationDescribedInIndex0() {
		...
		List<Entity> toEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("someFunction"));
