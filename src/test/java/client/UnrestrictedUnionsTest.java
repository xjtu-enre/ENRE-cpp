...
public class UnrestrictedUnionsTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "unrestricted-unions";
	...
	/**
	  * contains Union entity U
	  */
	@Test
	public void containsUnionEntityU2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isUnion(x) && x.getName().equals("U") && x.getLocation().getStartLine() == 2);
