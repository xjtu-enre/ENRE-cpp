...
public class TemplatesAsTemplateParametersTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "templates-as-template-parameters";
	...
	/**
	  * contains Template entity Arr
	  */
	@Test
	public void containsTemplateEntityArr1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("Arr") && x.getLocation().getStartLine() == 1);
