...
public class ClassWithFinalSpecifierTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "class-with-final-specifier";
	...
	/**
	  * contains Class entity Vector
	  */
	@Test
	public void containsClassEntityVector1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isClass(x) && x.getName().equals("Vector") && x.getLocation().getStartLine() == 1);
