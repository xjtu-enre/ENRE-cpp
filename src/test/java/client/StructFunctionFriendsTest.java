...
public class StructFunctionFriendsTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "struct-function-friends";
	...
	public void containsFriendRelationDescribedInIndex0() {
		...
		List<Entity> toEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("f"));
