...
public class UnnamedNamespaceTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "unnamed-namespace";
	...
	/**
	  * contains Namespace entity <Anonymous as="Namespace">
	  */
	@Test
	public void containsNamespaceEntity_Anonymous_asNamespace_1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isNamespace(x) && x.getName().equals("_Anonymous_asNamespace_") && x.getLocation().getStartLine() == 1);
