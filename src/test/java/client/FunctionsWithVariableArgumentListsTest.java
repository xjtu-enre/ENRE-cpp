...
public class FunctionsWithVariableArgumentListsTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "functions-with-variable-argument-lists";
	...
	/**
	  * contains Function entity func
	  */
	@Test
	public void containsFunctionEntityfunc1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("func") && x.getLocation().getStartLine() == 1);
