...
public class ClassWithObjectTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "class-with-object";
	...
	/**
	  * contains Class entity objClass
	  */
	@Test
	public void containsClassEntityobjClass1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isClass(x) && x.getName().equals("objClass") && x.getLocation().getStartLine() == 1);
