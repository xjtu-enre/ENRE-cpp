...
public class VirtualFunctionsTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "virtual-functions";
	...
	/**
	  ...
	  */
	@Test
	public void containsFunctionEntityfunc3() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isFunction(x) && x.getName().equals("func") && x.getLocation().getStartLine() == 3);
