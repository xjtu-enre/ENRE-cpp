...
public class VariadicTemplateTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "variadic-template";
	...
	/**
	  * contains Template entity tuple
	  */
	@Test
	public void containsTemplateEntitytuple1() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("tuple") && x.getLocation().getStartLine() == 1);
	...
	/**
	  ...
	  */
	@Test
	public void containsTemplateEntitytuple2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("tuple") && x.getLocation().getStartLine() == 2);
		Assert.assertEquals(1, filteredEntities.size());
		Entity ent = filteredEntities.get(0);
		int[] gt = {2, -1, -1, -1};
		Assert.assertArrayEquals(gt, TestUtil.expandLocationArray(ent.getLocation(), gt));
	...
	/**
	  * contains Template entity my_printf
	  */
	@Test
	public void containsTemplateEntitymy_printf3() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isTemplate(x) && x.getName().equals("my_printf") && x.getLocation().getStartLine() == 3);
		Assert.assertEquals(1, filteredEntities.size());
		Entity ent = filteredEntities.get(0);
		int[] gt = {3, -1, -1, -1};
		Assert.assertArrayEquals(gt, TestUtil.expandLocationArray(ent.getLocation(), gt));
