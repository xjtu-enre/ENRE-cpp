...
public class PointVariableTest {
	...
	public void execute() throws Exception {
		...
		String caseName = "point-variable";
	...
	/**
	  ...
	  */
	@Test
	public void containsVariableEntityp2() {
		List<Entity> filteredEntities = TestUtil.filter(entities, (x) -> judgeCate.isVar(x) && x.getName().equals("p") && x.getLocation().getStartLine() == 2);
