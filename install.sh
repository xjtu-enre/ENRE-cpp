...
mvn install:install-file -DgroupId=eclipse-photon -DartifactId=org.eclipse.core.runtime -Dversion=3.16.0.v20190823-1314  -Dpackaging=jar -Dfile=./jars/org.eclipse.core.runtime_3.16.0.v20190823-1314.jar  -DgeneratePom=true
...
mvn install:install-file -DgroupId=org.antlr -DartifactId=antlr4-runtime -Dversion=4.6 -Dpackaging=jar -Dfile=./jars/antlr4-runtime-4.6.jar -DgeneratePom=true
mvn install:install-file -DgroupId=com.fasterxml.jackson.core -DartifactId=jackson-databind -Dversion=2.9.10.1 -Dpackaging=jar -Dfile=./jars/jackson-databind-2.9.10.1.jar -DgeneratePom=true
mvn install:install-file -DgroupId=com.alibaba -DartifactId=fastjson -Dversion=1.2.58 -Dpackaging=jar -Dfile=./jars/fastjson-1.2.58.jar -DgeneratePom=true
mvn install:install-file -DgroupId=org.json -DartifactId=json -Dversion=20210307 -Dpackaging=jar -Dfile=./jars/json-20210307.jar -DgeneratePom=true
mvn install:install-file -DgroupId=com.google.code.gson -DartifactId=gson -Dversion=2.8.8 -Dpackaging=jar -Dfile=./jars/gson-2.8.8.jar -DgeneratePom=true
mvn install:install-file -DgroupId=info.picocli -DartifactId=picocli -Dversion=4.6.2 -Dpackaging=jar -Dfile=./jars/picocli-4.6.2.jar -DgeneratePom=true
